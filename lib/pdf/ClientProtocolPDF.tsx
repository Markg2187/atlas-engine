...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: 700, color: "#1a2744", marginBottom: 4 },
  ...
  value: { fontSize: 9, color: "#1a2744", width: "58%" },
  ...
  monthTitle: { fontSize: 10, fontWeight: 700, color: "#1a2744", marginBottom: 6 },
  ...
  tableCell: { fontSize: 8, color: "#1a2744" },
  disclaimer: {
    marginTop: 20,
    padding: 10,
  ...
  bodyText: { fontSize: 9, color: "#1a2744", lineHeight: 1.5 },
  bulletRow: { flexDirection: "row", marginBottom: 3 },
  bullet: { fontSize: 9, color: "#c9973a", width: 12 },
  bulletText: { fontSize: 9, color: "#1a2744", flex: 1, lineHeight: 1.4 },
  ...
  stepText: { fontSize: 9, color: "#1a2744", flex: 1, lineHeight: 1.4, marginLeft: 6 },
  infoBox: {
    backgroundColor: "#f5f3ee",
    borderRadius: 4,
    padding: "6 10",
  ...
  infoValue: { fontSize: 8, color: "#1a2744" },
  brandBadge: {
